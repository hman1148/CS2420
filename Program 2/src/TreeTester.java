...
//
        ...
        System.out.println("Tree to flipped: " + treeTwo.toString2());
        treeTwo.flip();   //Flip back
        treeTwo.changeName("TreeTwo");
        System.out.println("TreeTwo reversed back: " + treeTwo.toString2());
...
//
        ...
        System.out.println("All paths from tree Three");
...
//
        ...
        treeOne.changeName(" \ntreeOne after keeping only nodes between 14 and 50");
        System.out.println(treeOne.toString());
        ...
        treeFive.changeName("\n treeFive after keeping only nodes between 3  and 69");
        System.out.println(treeFive.toString());
