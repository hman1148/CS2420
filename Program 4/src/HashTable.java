...
public class HashTable<E> {
    ...
    private int findPos( E x ) {
        ...
        int offset = myhash(x) % (array.length - 2) + 1;
        numOfProbs += 1;
    ...
    public int getNumProbs() {
        return this.numOfProbs;
    }
    public void setNumOfProbs(int num) {
        this.numOfProbs = num;
    }
    ...
    public void setFindCounter(int num) {
        this.findCounter = num;
    }
    ...
    public void setNumItemsInTable(int number) {
        this.numItemsInTable = number;
    }
    ...
    public static void main( String [ ] args ) {
        ...
        HashTable<WordInfo> wordTable = new HashTable<>();
